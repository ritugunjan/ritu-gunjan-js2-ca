    ...
    function renderPost(postArray)
    {
        ...
        {
            container.insertAdjacentHTML('beforeend', postHtmlElement(element))
        });
    }
    ...
    function filterPostArray(searchString)
    {
        if (searchString.trim() === "")
        {
            return GlobalPost; // Return all elements if search string is empty
        } else
        {
            searchString = searchString.toLowerCase();
            return GlobalPost.filter(function (element)
            {
                return element?.body?.toLowerCase().includes(searchString);
            });
        }
    }
    ...
    function filterPost(event)
    {
        ...
        timer = setTimeout(() =>
        {
            let array = filterPostArray(event.value);
            renderPost(array);
